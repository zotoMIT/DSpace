...
(function($){
    ...
    function renderAdvancedFilterSection() {
        ...
        $('#aspect_discovery_SimpleSearch_row_filter-controls, #aspect_discovery_SimpleNonArchivedSearch_row_filter-controls').before(wrapper);
    ...
    function assignSimpleFilterEventHandlers() {
        $('#filters-overview-wrapper .label').click(function (e) {
            ...
            renderAdvancedFilterSection();
            $('#aspect_discovery_SimpleSearch_div_search-filters, #aspect_discovery_SimpleNonArchivedSearch_div_search-filters').submit();
            return false;
        });
    }
    ...
    function assignGlobalEventHandlers() {
        $('.show-advanced-filters').click(function () {
            var wrapper = $('#aspect_discovery_SimpleSearch_div_discovery-filters-wrapper, #aspect_discovery_SimpleNonArchivedSearch_div_discovery-filters-wrapper');
        ...
        $('#aspect_discovery_SimpleSearch_field_submit_reset_filter, #aspect_discovery_SimpleNonArchivedSearch_field_submit_reset_filter').click(function() {
        ...
        $('.controls-gear-wrapper').find('li.gear-option,li.gear-option a').click(function(event){
            ...
            mainForm = $('#aspect_discovery_SimpleSearch_div_main-form, #aspect_discovery_SimpleNonArchivedSearch_div_main-form');
