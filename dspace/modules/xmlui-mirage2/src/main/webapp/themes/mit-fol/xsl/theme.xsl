...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
    ...
    <xsl:import href="custom/aspect/submission/submission.xsl"/>
    <xsl:import href="custom/aspect/discovery/discovery.xsl"/>
    <xsl:import href="custom/aspect/discovery/discovery.xsl"/>
    <xsl:import href="custom/aspect/artifactbrowser/item-list.xsl"/>
    <xsl:import href="custom/aspect/artifactbrowser/item-view.xsl"/>
    <xsl:import href="custom/aspect/artifactbrowser/collection-view.xsl"/>
    <xsl:import href="custom/aspect/artifactbrowser/community-view.xsl"/>
    <xsl:import href="custom/aspect/general/choice-authority-control.xsl"/>
    <xsl:import href="custom/home.xsl"/>
    <xsl:import href="custom/core/navigation.xsl"/>
    <xsl:import href="custom/oastats.xsl"/>
