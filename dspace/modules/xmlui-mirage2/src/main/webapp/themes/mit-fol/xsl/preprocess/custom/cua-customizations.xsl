        ...
        <div rend="panel panel-default">
            ...
            <div rend="panel-heading">
                ...
                <xsl:choose>
                    <xsl:when test="@id='aspect.statistics.mostpopular.MostPopular.div.geo-stat-chart'">
                        <hi>
                            <i18n:text>wb.geochart.map_downloads_by_country</i18n:text>
                        </hi>
                    </xsl:when>
                    <xsl:otherwise>
                        <hi>
                            <i18n:text>wb.geochart.map_downloads_by_city</i18n:text>
                        </hi>
                    </xsl:otherwise>
                </xsl:choose>
            ...
            <div>
                ...
                <div rend="map" id="chart">
                    <hi>
                        <i18n:text>wb.geochart.map_placeholder</i18n:text>
                    </hi>
                </div>
                <div rend="areaLegend">
                    <hi>
                        <i18n:text>wb.geochart.legend_placeholder</i18n:text>
                    </hi>
                    <hi rend="geochartDisclaimer">
                        <hi rend="bold"><i18n:text>wb.geochart.disclaimer.label</i18n:text>:
                        </hi>
                        <hi>
                            <i18n:text>wb.geochart.disclaimer.text</i18n:text>
                        </hi>
                    </hi>
                </div>
            </div>
